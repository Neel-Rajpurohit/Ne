...
enum TaskCategory: String, Codable, CaseIterable, Sendable {
    ...
    var gradient: LinearGradient {
        switch self {
        case .steps: return LinearGradient(colors: [Color(hex: "667EEA"), Color(hex: "764BA2")], startPoint: .topLeading, endPoint: .bottomTrailing)
        case .water: return LinearGradient(colors: [Color(hex: "00D2FF"), Color(hex: "3A7BD5")], startPoint: .topLeading, endPoint: .bottomTrailing)
        case .sleep: return LinearGradient(colors: [Color(hex: "4F46E5"), Color(hex: "818CF8")], startPoint: .topLeading, endPoint: .bottomTrailing)
        case .activeMinutes: return LinearGradient(colors: [Color(hex: "F59E0B"), Color(hex: "EF4444")], startPoint: .topLeading, endPoint: .bottomTrailing)
        case .running: return LinearGradient(colors: [Color(hex: "EF4444"), Color(hex: "F97316")], startPoint: .topLeading, endPoint: .bottomTrailing)
        case .homework: return LinearGradient(colors: [Color(hex: "10B981"), Color(hex: "06B6D4")], startPoint: .topLeading, endPoint: .bottomTrailing)
        case .study: return LinearGradient(colors: [Color(hex: "3B82F6"), Color(hex: "8B5CF6")], startPoint: .topLeading, endPoint: .bottomTrailing)
        case .meditation: return LinearGradient(colors: [Color(hex: "7C3AED"), Color(hex: "A78BFA")], startPoint: .topLeading, endPoint: .bottomTrailing)
        case .gym: return LinearGradient(colors: [Color(hex: "EC4899"), Color(hex: "8B5CF6")], startPoint: .topLeading, endPoint: .bottomTrailing)
        case .custom: return LinearGradient(colors: [Color(hex: "8B5CF6"), Color(hex: "6366F1")], startPoint: .topLeading, endPoint: .bottomTrailing)
        }
    }
    
    var verificationType: TaskVerificationType {
        switch self {
        case .steps, .water, .sleep, .activeMinutes, .running:
            return .auto
...
struct DailyTask: Codable, Identifiable, Sendable {
    ...
    var currentDisplay: String {
        if category == .water {
            return currentValue >= 1000 ? String(format: "%.1fL", currentValue / 1000) : "\(Int(currentValue))mL"
        }
        if category == .sleep {
    ...
    var goalDisplay: String {
        if category == .water {
            return goalValue >= 1000 ? String(format: "%.1fL", goalValue / 1000) : "\(Int(goalValue))mL"
        }
        if category == .sleep {
    ...
    static func create(title: String, category: TaskCategory, goalValue: Double, xp: Int? = nil) -> DailyTask {
        DailyTask(
            id: UUID(),
            title: title,
