        ...
        NavigationStack {
            ScrollView(showsIndicators: false) {
                VStack(spacing: 20) {
                    ...
                    if let reminder = taskManager.stepReminderMessage {
                        HStack(spacing: 12) {
                        ...
                        .padding(16)
                        .background(
                            LinearGradient(colors: [AppTheme.warmOrange, Color(hex: "EF4444")], startPoint: .leading, endPoint: .trailing)
                        )
                        ...
                        HStack(spacing: 16) {
                            ...
                            ZStack {
                                ...
                                Circle()
                                    ...
                                    .stroke(
                                        LinearGradient(colors: [AppTheme.healthGreen, AppTheme.neonCyan], startPoint: .topLeading, endPoint: .bottomTrailing),
                            ...
                            VStack(alignment: .leading, spacing: 4) {
                                Text("Daily Tasks")
                                    ...
                                    .foregroundStyle(AppTheme.textPrimary)
                                Text("\(taskManager.dailyTaskSet.completedCount)/\(taskManager.dailyTaskSet.totalCount) completed")
                                    .font(.system(.caption, design: .rounded))
                                    .foregroundStyle(AppTheme.textSecondary)
                            }
