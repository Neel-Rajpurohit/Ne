...
struct ContentView: View {
    ...
    var body: some View {
        ZStack(alignment: .top) {
            TabView(selection: $selectedTab) {
                ...
                HealthQuizContainerView()
                    .tabItem { Label("Health & Quiz", systemImage: "heart.fill") }.tag(2)
    ...
    private var tabTint: Color {
        ...
        case 3: return AppTheme.primaryPurple
    ...
    private var morningGreetingOverlay: some View {
        VStack {
            ...
            VStack(spacing: 16) {
                ...
                Text(
                    ProfileManager.shared.profile.name.isEmpty
                        ? "" : "Let's go, \(ProfileManager.shared.profile.name)!"
                )
