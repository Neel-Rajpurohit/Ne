            ...
            VStack(spacing: 20) {
                ...
                VStack(alignment: .leading, spacing: 14) {
                    ...
                    VStack(alignment: .leading, spacing: 10) {
                        Text("Profile Photo").font(.system(.subheadline, design: .rounded, weight: .medium)).foregroundStyle(AppTheme.textSecondary)
                        HStack(spacing: 16) {
                            ZStack {
                                Circle().fill(AppTheme.studyBlue.opacity(0.15)).frame(width: 60, height: 60)
                                ...
                                ForEach(availableCharacters, id: \.self) { char in
                                    Button(action: {
                                        ...
                                        Text(char)
                                            ...
                                            .background(
                                                Circle()
                                                    .fill(selectedCharacter == char ? AppTheme.studyBlue.opacity(0.3) : Color.white.opacity(0.05))
                                                    .overlay(
                                                        Circle().stroke(selectedCharacter == char ? AppTheme.studyBlue : Color.clear, lineWidth: 2)
                                                    )
                                            )
                                    }
