...
enum BlockType: String, Codable, CaseIterable {
    ...
    var icon: String {
        ...
        case .school, .college: return "building.columns.fill"
    ...
    var lightColor: Color {
        ...
        case .school, .college: return Color(hex: "3B82F6")
    ...
    var canCompleteManually: Bool {
        switch self {
        case .school, .college, .lunch, .freeTime, .tuition:
            return true
        default:
            return false
        }
...
struct TimeBlock: Codable, Identifiable {
    ...
    init(
        type: BlockType, subject: String? = nil, startHour: Int, startMinute: Int, endHour: Int,
        endMinute: Int, cycles: Int = 2, studyDuration: Int = 25, breakDuration: Int = 5
    ) {
        self.id = UUID()
        self.type = type
    ...
    var displayTitle: String {
        if type == .lunch, let subject = subject { return subject }
